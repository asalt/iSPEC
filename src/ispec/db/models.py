...
class Person(TIMESTAMP_MIXINS['ppl'], Base):
    ...
    ppl_Domain: Mapped[str] = mapped_column(Text)
    ppl_Email: Mapped[str] = mapped_column(Text)
    ppl_Phone: Mapped[str] = mapped_column(Text)
    ppl_PI: Mapped[str] = mapped_column(Text)
    ppl_Institution: Mapped[str] = mapped_column(Text)
    ppl_Center: Mapped[str] = mapped_column(Text)
    ppl_Department: Mapped[str] = mapped_column(Text)
    ppl_Status: Mapped[str] = mapped_column(Text)

    ppl_Roles_PI: Mapped[str] = mapped_column(Text)
    ppl_Roles_CoreUser: Mapped[str] = mapped_column(Text)
    ppl_Roles_CoreStaff: Mapped[str] = mapped_column(Text)
    ppl_Roles_Collaborator: Mapped[str] = mapped_column(Text)
    ppl_Roles: Mapped[str] = mapped_column(Text)
...
class Project(TIMESTAMP_MIXINS['prj'], Base):
    ...
    prj_iLabs_RequestName: Mapped[str] = mapped_column(Text)
    prj_ProjectTitle: Mapped[str] = mapped_column(Text)
    prj_RnD: Mapped[str] = mapped_column(Text)
    prj_CancerRelevance: Mapped[str] = mapped_column(Text)
    prj_CPRIT_RFP: Mapped[str] = mapped_column(Text)
    prj_PI: Mapped[str] = mapped_column(Text)
    prj_Project_LabContact: Mapped[str] = mapped_column(Text)
    prj_Project_LabPersonnel: Mapped[str] = mapped_column(Text)
    ...
    prj_Date_Submitted: Mapped[str] = mapped_column(Text)
    ...
    prj_Invoice_Date: Mapped[str] = mapped_column(Text)
    prj_Billing_Date: Mapped[str] = mapped_column(Text)
    prj_PaymentReceived: Mapped[str] = mapped_column(Text)
    prj_ProjectDomainMSPC: Mapped[str] = mapped_column(Text)
    prj_Project_SampleHandling: Mapped[str] = mapped_column(Text)
    prj_ExpCount: Mapped[int] = mapped_column(Integer)
    prj_ExpRunCount: Mapped[int] = mapped_column(Integer)
    prj_MSFilesCount: Mapped[int] = mapped_column(Integer)
    prj_MSRunTime: Mapped[float] = mapped_column(Float)
    prj_MSPCEmail: Mapped[str] = mapped_column(Text)
    prj_PaidPrice: Mapped[float] = mapped_column(Float)
    prj_ProjectCostMinimum: Mapped[float] = mapped_column(Float)
    prj_ProjectCostMaximum: Mapped[float] = mapped_column(Float)
    prj_Current_FLAG: Mapped[bool] = mapped_column(Boolean)
    prj_Billing_ReadyToBill: Mapped[bool] = mapped_column(Boolean)
